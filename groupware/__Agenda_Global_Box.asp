...
<IMG BORDER=0 HEIGHT=11 SRC="Images/OverApps-left_small.gif" WIDTH=11></A> <FONT color="<%= myBGTextColor %>" face=Arial,Helvetica size=1><a href="__Agenda_Global_Day.asp?Date_Agenda=<%=myIntDate_Agenda%>">
<%
...
<A href="__Agenda_Global_Day.asp"><FONT size="1" face="Arial,Helvetica" Color="Blue"><B><%=myMessage_Today%></b></font></A> 
</TD>
</TR> 
</table>
</td>
...
If DatePart("w",myIntFirst_Day_Of_Month-myNumDay+i) = 7 Then response.write Ucase(left(myMessage_Saturday,1))
...
<a href="__Agenda_Global_Day.asp?Date_Agenda=<%=DateSerial(Year(myDateNumVar),Month(myDateNumVar),Day(myDateNumVar))%>"> 
